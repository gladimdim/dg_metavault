---
title: "Generation and Render of 2D Map with Terrain in Dart + Flutter. Adding Forest Spots. Part 2"
date: 2020-09-12
...
---
# Introduction
In  [Part 1]([[flutter_generation_and_render_2d_map_part1]]) we created all needed methods to generate map with Grass and River. In this part we will add Forest spots to the map. A lot of code is reused from Part 1 but it is gradually enhanced step-by-step.
